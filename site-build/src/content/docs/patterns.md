...
order: 6
group: Patterns
description: Reusable solutions to recurring problems, named by task. Components serve patterns, not the other way round.
---

# Interaction pattern library

Pages are named by task or problem, so each one connects components, states, and flows. A "button" is a component; "helping a user complete one reliable selection while tracking is unstable" is a pattern.
